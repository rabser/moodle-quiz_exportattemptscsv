...
$string['exportattemptscsv:download'] = 'Export Attempts history as CSV';
...
$string['privacy:preference:gdpr'] = 'Whether personal-information columns are included in the export.';
$string['privacy:preference:qtext'] = 'Whether the question - text column is included in the export.';
$string['privacy:preference:resp'] = 'Whether the response column is included in the export.';
$string['privacy:preference:right'] = 'Whether the right - answer column is included in the export.';
